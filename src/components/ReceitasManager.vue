...
<template>
    <div class="max-w-4xl mx-auto p-6 space-y-8 animate-fade-in pb-20">
        ...
        <div class="space-y-4">
            <div v-for="r in props.listaReceitas" :key="r.id" class="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition flex items-center justify-between border-l-4 border-l-green-500">
                <div>
